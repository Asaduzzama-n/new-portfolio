            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="space-y-8">
                    {projects.map((project, index) => (
                        ...
                        >
                            {/* Static White Block (revealed when card lifts) */}
                            <div className="absolute inset-0 bg-white rounded-[40px] opacity-0 group-hover:opacity-100 transition-opacity duration-300" />

                            <div className="relative grid md:grid-cols-2 bg-primary rounded-[40px] overflow-hidden transition-all duration-300 group-hover:-translate-x-3 group-hover:-translate-y-3">
                                {/* Content */}
